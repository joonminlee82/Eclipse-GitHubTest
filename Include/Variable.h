...
//-----------sampling & switching-------//
#ifdef __5KHZ
#define SWITCHING_FRQ       5.0e3  //여기서 스위칭 주파수 설정하면, EPWM에서도 자동으로 설정됨 (F2837xD_EPwm.c 참조)
#define SAMPING_METHOD      1.0     //여기서 결정하면, variable.c에서 정의한 Tsamp 가 자동 설정됨 (F2837xD_EPwm.c 참조)
#define PWM_INT_NUM         1       // 2 for 15kHz Switching, 3 for 10kHz Switching
#define CC_FREQ             5.0e3  // 전류 제어기 주파수
#endif

#ifdef __10KHZ
#define SWITCHING_FRQ	    30.0e3	//여기서 스위칭 주파수 설정하면, EPWM에서도 자동으로 설정됨 (F2837xD_EPwm.c 참조)
#define SAMPING_METHOD  	1.0 	//여기서 결정하면, variable.c에서 정의한 Tsamp 가 자동 설정됨	(F2837xD_EPwm.c 참조)
#define PWM_INT_NUM			3		// 2 for 15kHz Switching, 3 for 10kHz Switching
#define CC_FREQ				10.0e3	// 전류 제어기 주파수
#endif
...
#define CC_FREQ				15.0e3	// 전류 제어기 주파수
#endif
...
#define SAMPING_METHOD  	1.0 	//여기서 결정하면, variable.c에서 정의한 Tsamp 가 자동 설정됨	(F2837xD_EPwm.c 참조)
#define PWM_INT_NUM			1		// 2 for 15kHz Switching, 3 for 10kHz Switching
#define CC_FREQ				30.0e3	// 전류 제어기 주파수
#endif
