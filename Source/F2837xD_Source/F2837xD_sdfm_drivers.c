...
void Init_SDFM(void)
{
	...
	//Sdfm_configureInputCtrl(SDFM1, FILTER1, MODE_3);//MODE_1 설정시 SDFM 데이터 read 오류 현상 발생함!!
	//Sdfm_configureInputCtrl(SDFM1, FILTER2, MODE_3);

	/*******************************************************/
	/* Comparator Module */
	/*******************************************************/
	//HLT = 0xFFFF;    //Over value threshold settings
