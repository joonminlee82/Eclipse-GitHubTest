...
void InitPeripheralClocks()
{
	...
	ClkCfgRegs.PERCLKDIVSEL.bit.EPWMCLKDIV = 0; // EPWMCLKDIV=0 : 시스템클럭/1, EPWMCLKDIV=1: 시스템클럭/2; => PWM 클럭 설정
...
{
    volatile Uint16 temp;
    //volatile long int *ECSL = (volatile int *)0x5F00;
		//volatile long int *ECSLPWL = (volatile int *)0x78028;
